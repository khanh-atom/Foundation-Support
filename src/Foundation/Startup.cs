...
namespace Foundation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<PromotionOptions>(options =>
            {
                options.PromotionExclusionLevel = ExclusionLevel.Unit; // or ExclusionLevel.Order
                options.ApplyPromotionUnitIndividually = true;
            });
            ...
            services.AddHttpClient("oid-token-client", client =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // Workaround for Advanced.CMS.ApprovalReviews bug: rewrite adminPlugin.js/css to admin-plugin.js/css
            //app.UseMiddleware<Infrastructure.Cms.AdminPluginFileRewriteMiddleware>();
