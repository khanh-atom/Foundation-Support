...
if not exist "%SOURCEPATH%\Foundation\appsettings.Development.json" (
	echo ## Creating appsettings.Development.json from appsettings.temp.json ##
	copy /Y "%SOURCEPATH%\Foundation\appsettings.temp.json" "%SOURCEPATH%\Foundation\appsettings.Development.json"
)
